...
# set paths
bids_path=/oak/stanford/groups/russpold/data/NARPS/ds001205 #ADD FULL PATH HERE WITHOUT / AT THE END
event_files_path=/oak/stanford/groups/russpold/data/NARPS/event_tsvs #ADD FULL PATH HERE WITHOUT / AT THE END
